...
<head>
<meta charset="UTF-8">
<title>Start to implement a task</title>
...
<body background="img/kiwi.jpg" style="font-size: 20px;">
	...
	<form:form action="moveTaskFromTakenToInProgress" method="post" modelAttribute="taskToMove">
	...
	<c:choose>
		<c:when test="${not empty tasksTakenByDeveloper}">
			<div align = "center">
			<table>
					<tr> <td> Select the task you want to start implementing :  </td>
					</tr>
					<tr>
						<td>
						 <form:select path="id">
					...
					<tr>
						<td><input type="submit" value="Start implementation" style="font-size: 14px" /></td>
					</tr>
			</table>
			</div>
		</c:when>
		...
		<c:otherwise>
				<div align = "center" style="color: red;">
					<b> You have no tasks assigned ! </b>
				</div> 
		</c:otherwise>
	</c:choose>
