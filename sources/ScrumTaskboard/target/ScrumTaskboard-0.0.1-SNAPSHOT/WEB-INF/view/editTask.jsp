...
<body background="img/kiwi.jpg" style="font-size: 20px; padding-left: 20px">
	...
	<h1 align="left" style="font-size:20px; color: rgb(0,51,102); padding-left: 30px"> Update task : </h1>

<div>
	<form:form action="editTask" method="post" modelAttribute="taskToEdit">
	<div style="float: left; font-size: 20px; padding-right: 30px;">				
		<table>
			...
			<tr>
				<td><input type="submit" value="Update task" style="font-size: 14px"/></td>
			</tr>
		</table>
	</div>
	</form:form>
