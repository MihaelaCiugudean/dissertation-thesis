...
<body background="img/kiwi.jpg" style="font-size: 20px; padding-left: 20px">
	...
	<form:form action="deleteTask" method="post"
		modelAttribute="taskToDelete">
		<c:choose>
		<c:when test="${not empty tasksNotTaken}">
			<table>
				<tbody>
					<tr>
						<td style="color:rgb(0,51,102);">Select task to delete :</td>
						<td>
						 <form:select path="id">
		...
		<c:otherwise>
			<div align = "center" style="color: red;">
				<b> There are no free tasks to delete ! </b>
			</div> 
		</c:otherwise>
