...
<head>
<meta charset="UTF-8">
<title>Submit a task implementation</title>
...
<body background="img/kiwi.jpg" style="font-size: 20px;">
	...
	<form:form action="moveTaskFromInProgressToInReview" method="post" modelAttribute="taskToMove">
	...
	<c:choose>
		<c:when test="${not empty tasksInProgressForDeveloper}">
			<div align = "center">
			<table>
					<tr> <td> Select the task you want to submit :  </td>
					</tr>
					<tr>
						<td>
						 <form:select path="id">
					...
					<tr>
						<td><input type="submit" value="Submit task implementation" style="font-size: 14px"/></td>
					</tr>
			</table>
			</div>
		...
		<c:otherwise>
			<div align = "center" style="color: red;">
				<b> You have no tasks to submit ! </b>
			</div> 
		</c:otherwise>
