...
<body background="img/kiwi.jpg" style="font-size: 20px; padding-left: 20px">
	...
	<c:choose>
		<c:when test="${not empty commentsForDeveloper}">
		<h1 align="left" style="font-size:20px; color: rgb(0,51,102); padding-left: 20px">
			The following comments were posted for the tasks you implemented :
		</h1>
			<table border="1" width="300" height="200"
				...
				<tbody>
					<c:forEach items="${commentsForDeveloper}" var="comment">
						<tr>
		...
		<c:otherwise>
			...
			<h1 align="left" style="font-size:20px; color: rgb(0,51,102); padding-left: 20px">
				 You have no comments for the implemented tasks !
			</h1>
			</div> 
		</c:otherwise>
