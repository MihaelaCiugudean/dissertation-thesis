...
<title>Skill Upgrades Page</title>
...
<body background="img/kiwi.jpg" style="font-size: 20px; padding-left: 20px">
	...
	<c:choose>
		<c:when test="${not empty skillUpgradesForTasksInDone}">
		...
		<br>
		<div align="center">
			<a href="<c:url value="/upgradeSkillSelectTask" />">Upgrade skill</a>
		</div>
		...
		<c:otherwise>
			...
			<h1 align="left" style="font-size:20px; color: rgb(0,51,102); padding-left: 20px">
				 There are no proposed skill upgrades !
			</h1>
			</div> 
		</c:otherwise>
	</c:choose>
