...
<body background="img/kiwi.jpg" style="font-size: 20px; padding-left: 20px">
	...
	<div style="float: right; padding-top: 50px; padding-right: 180px;"> 
	<form:form action="upgradeSkillSelectTask" method="post"
		modelAttribute="task">
			<table>
				<tbody>
					<tr>
						<td style="color:rgb(0,51,102);">Select task for which to upgrade a skill :</td>
						<td>
						 <form:select path="id">
								<!-- <option value="">- Please choose -</option> -->
	               			    <form:options items="${tasksInDone}" itemValue="id" itemLabel="description"/>
	                            <form:errors path="id"/>
					     </form:select>
				        </td>
					</tr>
