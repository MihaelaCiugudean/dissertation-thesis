...
<head>
<meta charset="UTF-8">
<title>Restart a task implementation</title>
...
<body background="img/kiwi.jpg" style="font-size: 20px;">
	...
	<form:form action="moveTaskFromInReviewToInProgressByDeveloper" method="post" modelAttribute="taskToMove">
	...
	<c:choose>
		<c:when test="${not empty tasksInReviewForDeveloper}">
			<div align = "center">
			<table>
					<tr> <td> Select the task you want to restart implementing :  </td>
					</tr>
					<tr>
						<td>
						 <form:select path="id">
						 		<!-- <option value="">-Please choose-</option> -->
	               			    <form:options items="${tasksInReviewForDeveloper}" itemValue="id" itemLabel="description"/>
	                            <form:errors path="id"/>
					     </form:select>
				        </td>
					</tr>
					...
					<tr>
						<td><input type="submit" value="Restart implementation" style="font-size: 14px"/></td>
					</tr>
			</table>
			</div>
		</c:when>
		...
		<c:otherwise>
			<div align = "center" style="color: red;">
				<b> You have no tasks in review ! </b>
			</div> 
		</c:otherwise>
