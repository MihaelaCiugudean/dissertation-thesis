...
<body background="img/kiwi.jpg" style="font-size: 20px;">
	...
	<form:form action="moveTaskFromNotTakenToTaken" method="post" modelAttribute="taskToMove">
	...
	<c:choose>
		<c:when test="${not empty tasksNotTaken}">
			<div align = "center">
			<table>
					<tr> <td> Select the task you want to take :  </td>
					</tr>
					<tr>
						<td>
						 <form:select path="id">
					...
					<tr>
						<td><input type="submit" value="Assign task" style="font-size: 14px"/></td>
					</tr>
			</table>
			</div>
		</c:when>
		...
		<c:otherwise>
			<div align = "center" style="color: red;">
				<b> There are no tasks available to be implemented ! </b>
			</div> 
		</c:otherwise>
