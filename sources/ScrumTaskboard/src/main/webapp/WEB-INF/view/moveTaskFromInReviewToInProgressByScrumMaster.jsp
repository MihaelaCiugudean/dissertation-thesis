...
<head>
<meta charset="UTF-8">
<title>Decline a task implementation</title>
...
<body background="img/kiwi.jpg" style="font-size: 20px;">
	...
	<form:form action="moveTaskFromInReviewToInProgressByScrumMaster" method="post" modelAttribute="taskToMove">
	...
	<c:choose>
		<c:when test="${not empty tasksInReview}">
			<div align = "center">
			<table>
					<tr> <td> Select the task you want to decline :  </td>
					</tr>
					<tr>
						<td>
						 <form:select path="id">
					...
					<tr>
						<td><input type="submit" value="Decline implementation" style="font-size: 14px"/></td>
					</tr>
			</table>
			</div>
		</c:when>
